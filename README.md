...
PVC and moves messages. The chart deploys it three ways. 39 node types.
...
**Not done yet.** HTTP In/Response/Request, WebSocket, TCP and UDP nodes.
Subflow execution — subflows parse and round-trip but instances do not run yet.
Registering the chart in the dashboard's `HelmRepoURLs`.
